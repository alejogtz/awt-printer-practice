...
public class PresetsColor
{
   ...
   private List OptionsList;
    ...
    private void showListDemo(){
        ...
        OptionsList.add("Black and White");
        OptionsList.add("Black and White - Draft");
        ...
        option3.setText(">Media & Quality");
        option3.setBounds(10, 310, 100,15);

        Label M_Feed = new Label();
        M_Feed.setText("Media Feed");
        M_Feed.setBounds(50, 340, 100,20);

        Label M_Type = new Label();
        M_Type.setText("Media Type");
        M_Type.setBounds(50,370, 100,20);

        Label M_Quality = new Label();
        M_Quality.setText("Media Quality");
        M_Quality.setBounds(50, 400, 70,20);

        //FIN DE LA OPCION 3 

        //OPCION 4 
        Label option4 = new Label();
        option4.setText(">Layout");
        option4.setBounds(10, 430, 100,15);

        Label PP_Sheet = new Label();
        PP_Sheet.setText("Pages Per Sheet");
        PP_Sheet.setBounds(50, 460, 100,20);

        Label L_Direction = new Label();
        L_Direction.setText("Layout Direction");
        L_Direction.setBounds(50,490, 100,20);

        Label Border = new Label();
        Border.setText("Border");
        Border.setBounds(50, 520, 70,20);

        Label T_Sided = new Label();
        T_Sided.setText("Two-Sided");
        T_Sided.setBounds(50, 550, 70,20);

        Label Booklet = new Label();
        Booklet.setText("Booklet");
        Booklet.setBounds(50,580, 55,20);

        Label RP_Orientation = new Label();
        RP_Orientation.setText("Reverse Page Orientation");
        RP_Orientation.setBounds(50, 610, 150,20);

        Label F_Horizontally = new Label();
        F_Horizontally.setText("Flip Horizontally");
        F_Horizontally.setBounds(50, 640, 100,20);

        //FIN DE LA OPCION 4
        //OPCION 5
        Label option5 = new Label();
        option5.setText(">Paper Handling");
        option5.setBounds(10, 670, 100,15);

        Label C_pages = new Label();
        C_pages.setText("Collate pages");
        C_pages.setBounds(50, 700,100,20);

        Label PT_print = new Label();
        PT_print .setText("Pages To print ");
        PT_print .setBounds(50, 730, 100,20);

        Label DP_Size = new Label();
        DP_Size.setText("Destination Paper Size");
        DP_Size.setBounds(50, 760, 180,20);

        Label P_Order = new Label();
        P_Order.setText("Page Order");
        P_Order.setBounds(50, 790, 100,20);
        //FIN DE LA OPCION 5

        //OPCION 6
        Label option6 = new Label();
        option6.setText(">Cover Page");
        option6.setBounds(10, 820, 100,15);

        Label PC_Page = new Label();
        PC_Page.setText("Print Cover Page");
        PC_Page.setBounds(50, 850,100,20);
        //FIN DE LA OPCION 6

        //VALUE DE LA OPCION 1
        ...
        //FIN VALUE DE LA OPCION 1

        //VALUE DE LA OPCION 2
        ...
        // FIN VALUE DE LA OPCION 2

        //VALUE DE KA OPCION 3

        Label R_M_Feed = new Label();
        R_M_Feed.setText("Auto Select");
        R_M_Feed.setBounds(250, 340, 100,20);

        Label R_M_Type = new Label();
        R_M_Type.setText("Auto Select");
        R_M_Type.setBounds(250,370, 200,20);

        Label R_M_Quality = new Label();
        R_M_Quality.setText("Normal");
        R_M_Quality .setBounds(250, 400, 70,20);

        Label R_T_Sided = new Label();
        R_T_Sided.setText("Off");
        R_T_Sided.setBounds(250, 430, 70,20);

        //FIN VALUE DE LA OPCION 3

        //VALUE DE LA OPCION 4

        Label R_PP_Sheet = new Label();
        R_PP_Sheet.setText("1");
        R_PP_Sheet.setBounds(250, 460, 100,20);

        Label R_L_Direction = new Label();
        R_L_Direction.setText("Left-Right-Top-Bottom");
        R_L_Direction.setBounds(250,490, 200,20);

        Label R_Border = new Label();
        R_Border.setText("None");
        R_Border.setBounds(250, 520, 70,20);

        Label R_T_Sided1 = new Label();
        R_T_Sided1.setText("Off");
        R_T_Sided1.setBounds(250, 550, 70,20);

        Label R_Booklet = new Label();
        R_Booklet.setText("Off");
        R_Booklet.setBounds(250,580, 55,20);

        Label R_RP_Orientation = new Label();
        R_RP_Orientation.setText("Off");
        R_RP_Orientation.setBounds(250, 610, 150,20);

        Label R_F_Horizontally = new Label();
        R_F_Horizontally.setText("Off");
        R_F_Horizontally.setBounds(250, 640, 100,20);
        //FIN VALUE DE LA OPCION 4

        //VALUE DE LA OPCION 5

        Label R_C_pages = new Label();
        R_C_pages.setText("On");
        R_C_pages.setBounds(250, 700,100,20);

        Label R_PT_print = new Label();
        R_PT_print .setText("All pages");
        R_PT_print .setBounds(250, 730, 100,20);

        Label R_DP_Size = new Label();
        R_DP_Size.setText("Document paper: US Letter");
        R_DP_Size.setBounds(250, 760, 180,20);

        Label R_P_Order = new Label();
        R_P_Order.setText("Automatic");
        R_P_Order.setBounds(250, 790, 100,20);
        //FIN VALUE DE LA OPCION 5

        //VALUE DE LA OPCION 6

        Label R_PC_Page = new Label();
        R_PC_Page.setText("None");
        R_PC_Page.setBounds(250, 850,100,20);
        //FIN VALUE DE LA OPCION 6
        ...
        controlScroll.add(M_Feed);
        controlScroll.add(R_M_Feed);
        controlScroll.add(M_Type);
        controlScroll.add(R_M_Type);
        controlScroll.add(M_Quality);
        controlScroll.add(R_M_Quality);
